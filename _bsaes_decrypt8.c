...
extern void _bsaes_decrypt8_1000000(void *key, long rounds);
extern void _bsaes_decrypt8(void);
...
#define ITERATIONS 1000000
    ...
    uint64_t t1 = gettime();
    for (int i = ITERATIONS; i != 0; --i)
        wrapper(_bsaes_decrypt8, key, MAX_ROUNDS);
    uint64_t t2 = gettime();
...
void fuzz(unsigned int seed)
{
    ...
    wrapper(_bsaes_decrypt8, key, rounds);
