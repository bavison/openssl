...
rsync -av 192.168.0.172:openssl/bsaes_xts_encrypt.c .
...
gcc -c -mfpu=neon-vfpv4 -g -Wall -Wextra -O2 -o bsaes_xts_encrypt.o bsaes_xts_encrypt.c
gcc -g -o bsaes_xts_encrypt bsaes_xts_encrypt.o crypto/aes/bsaes-armv7.o crypto/aes/aes_cbc.o crypto/modes/cbc128.o crypto/aes/aes-armv4.o
